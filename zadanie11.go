...
func main() {
	...
	products := []Product{
		{"Яблоко", "Фрукты", 50},    // товар подходит под фильтры
		{"Картофель", "Овощи", 80},  // товар не подходит по категории
		{"Апельсин", "Фрукты", 100}, // товар не подходит по цене
		{"Огурец", "Овощи", 40},     // товар не подходит по категории
		{"Манго", "Фрукты", 60},     // товар подходит под фильтры
	}
